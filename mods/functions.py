...
def gen_pass():
    global password
    print(color.BLUE+"Generating random password of size "+plen+"..."+color.END)
    password = ''
    ...
    print(color.GREEN+"[+] Password generated: "+password+color.END)

def store():
    print(color.BLUE+"Storing data in "+os.path.splitext(outf)[0]+"..."+color.END)
